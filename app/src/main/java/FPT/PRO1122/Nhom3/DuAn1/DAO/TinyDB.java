...
public class TinyDB {
    ...
    public ArrayList<MonAnByThien> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<MonAnByThien> playerList =  new ArrayList<MonAnByThien>();

        for(String jObjString : objStrings){
            MonAnByThien player  = gson.fromJson(jObjString,  MonAnByThien.class);
    ...
    public void putListObject(String key, ArrayList<MonAnByThien> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(MonAnByThien player: playerList){
